...
<<<<<<< HEAD:test/metabase/metabot/tools/shared/llm_representations_test.clj
           (#'llm-rep/escape-xml "<script>alert(\"xss\")</script>"))))
||||||| 0a60f2436f:test/metabase/metabot/tools/shared/llm_representations_test.clj
           (#'llm-rep/escape-xml "<script>alert(\"xss\")</script>"))))

=======
           (#'llm-shape/escape-xml "<script>alert(\"xss\")</script>"))))
>>>>>>> v0.62.1:test/metabase/metabot/tools/shared/llm_shape_test.clj
