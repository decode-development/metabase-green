...
<<<<<<< HEAD:frontend/src/metabase/metabot/components/MetabotAdmin/MetabotSetup.tsx
  const isMutating =
    isConnecting || isDisconnecting || updateSettingsResult.isLoading;
||||||| 0a60f2436f:frontend/src/metabase/metabot/components/MetabotAdmin/MetabotSetup.tsx
  const isLoading =
    isConnecting ||
    isDisconnecting ||
...
=======
  ...
  const isMutating =
    isConnecting || isDisconnecting || updateSettingsResult.isLoading;
>>>>>>> v0.62.1:frontend/src/metabase/admin/ai/MetabotSetup.tsx
