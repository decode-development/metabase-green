...
<<<<<<< HEAD:frontend/src/metabase/metabot/components/MetabotAdmin/MetabotSetup.unit.spec.tsx
...
||||||| 0a60f2436f:frontend/src/metabase/metabot/components/MetabotAdmin/MetabotSetup.unit.spec.tsx
=======
  it("disconnects an env-backed API-key provider by clearing only the provider setting", async () => {
    await setup({
      apiKeySettingIsEnv: true,
...
>>>>>>> v0.62.1:frontend/src/metabase/admin/ai/MetabotSetup.unit.spec.tsx
